...
class MangaReaderScreenState extends State<MangaReaderScreen>
  ...
  void _tryInitialNavigation() {
    ...
    if (widget.isPageBack || _currentStep == 0) {
      _currentStep = widget.detectedPanels.length;
    } else if (widget.isPageBack || _currentStep != 0) {
      widget.isPageBack = false;
    }
                ...
                children: [
                  Positioned.fill(
                    child: DecoratedBox(
                      ...
                      child: Image.file(widget.mangaImage, fit: BoxFit.fill),
                    ),
                  ),
                  //               Positioned.fill(
                  //                 child: IgnorePointer(
